...
from ros2bag.api import covert_action_to_all_related_topics
...
class RecordVerb(VerbExtension):
    ...
    def main(self, *, args):  # noqa: D102
        ...
        record_options.actions = covert_action_to_all_related_topics(args.actions)
        ...
        record_options.exclude_actions = covert_action_to_all_related_topics(args.exclude_actions)
